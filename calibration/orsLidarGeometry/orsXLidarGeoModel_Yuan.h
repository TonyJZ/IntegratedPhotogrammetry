#ifndef _ORS_LIDARGEOMETRY_MODEL_YUAN_INCLUDE_H_
#define _ORS_LIDARGEOMETRY_MODEL_YUAN_INCLUDE_H_
...
class orsXLidarGeoModel_Yuan:  public orsILidarGeoModel, public orsObjectBase
{
private:
	//局部坐标系定义为XYZ -->  东北天
...
public:
	orsXLidarGeoModel_Yuan(bool bForRegister);
	virtual ~orsXLidarGeoModel_Yuan();
...
public:
	ORS_OBJECT_IMP1( orsXLidarGeoModel_Yuan, orsILidarGeoModel, "Yuan", "Yuan" );
};
