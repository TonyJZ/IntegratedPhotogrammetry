...
public:
	...
	//提取多边形内的点
	void GetPoints(orsPOINT3D *pPolygon, int ptNum, std::vector<ATNPoint> *ptDataVec);

	//提取点所在的三角形顶点,计算均方差
	locateresult GetTriangleVertex(orsPOINT3D *pt, double radius, std::vector<ATNPoint> *ptDataVec, double *rmse);
