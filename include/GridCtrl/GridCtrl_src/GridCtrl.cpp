...
void CGridCtrl::OnHScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
    ...
    case SB_PAGERIGHT:
        if (scrollPos < m_nHScrollMax)
        {
            ...
            int pos = m_nHScrollMax<scrollPos + offset ? m_nHScrollMax : scrollPos + offset;
				//min(m_nHScrollMax, scrollPos + offset);
...
void CGridCtrl::OnVScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
    ...
    case SB_PAGEDOWN:
        ...
        {
            rect.top = GetFixedRowHeight();
            scrollPos = m_nVScrollMax<scrollPos + rect.Height()?m_nVScrollMax:scrollPos + rect.Height();
				//min(m_nVScrollMax, scrollPos + rect.Height());
                              ...
                              BOOL bForceRedraw /*=FALSE*/, BOOL bSelectCells /*=TRUE*/)
{
    ...
    if (GetSingleColSelection())
        ...
        SetSelectedRange(GetFixedRowCount(),
						 ...
						 m_SelectionStartCell.col<currentCell.col?m_SelectionStartCell.col:currentCell.col,
                         GetRowCount()-1,
                         m_SelectionStartCell.col>currentCell.col?m_SelectionStartCell.col:currentCell.col,
                           ...
                           BOOL bForceRedraw /*=FALSE*/, BOOL bSelectCells /*=TRUE*/)
{
    ...
    if (GetSingleRowSelection())
        ...
        SetSelectedRange(m_SelectionStartCell.row<currentCell.row?m_SelectionStartCell.row:currentCell.row,
						//min(m_SelectionStartCell.row, currentCell.row),
                         Left,
